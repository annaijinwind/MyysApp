package com.maoyan.fengjianqi.myysapp.location;
...
import com.maoyan.fengjianqi.myysapp.MainActivity;
import com.maoyan.fengjianqi.myysapp.R;
import com.maoyan.fengjianqi.myysapp.utils.AmapUtils;
...
public class CityActivity extends AppCompatActivity implements OnScrollListener,AMapLocationListener {
    @BindView(R.id.sh) EditText sh;
    @BindView(R.id.tv_noresult)TextView tv_noresult;
    @BindView(R.id.list_view) ListView personList;
    @BindView(R.id.search_result) ListView resultList;
    ...
    private int locateProcess = 2; // 记录当前定位的状态 正在定位-定位成功-定位失败
    private boolean isNeedFresh;

    private DatabaseHelper helper;

    private ImageView iv_finish;
    private static String splash="0";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        personList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (splash.equals("1")){
                    Intent ii=new Intent(CityActivity.this, MainActivity.class);
                    startActivity(ii);
                    finish();
                }else {
                    finish();
